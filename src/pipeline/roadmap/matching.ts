...
// מבקש (internal_tools של ממד התהליכים, למשל) לא יכול לצרף ציטוט לאף פריט. manual_tasks נכנס
// לרשימה ב-16.8 כשסבב ה-AI זרע שני פריטים שמבקשים אותו (סוכן התוכן וסוכן הצעות המחיר);
...
const PAIN_KEYWORD_RULES: PainKeywordRule[] = [
  ...
  { keywords: ["ידני", "ידנית", "ידניות", "אקסל"], ruleKeys: ["lead_handling", "manual_tasks"] },
