...
const PAIN_KEYWORD_RULES: PainKeywordRule[] = [
  ...
  // פריט אימות הדואר (20.8): "המיילים שלי נופלים לספאם" הוא בדיוק הכאב שהוא פותר, וזה
  // גם המשפט שבעל עסק אומר בפועל - הוא לא יאמר "אין לי SPF". "דואר" לא נכלל בכוונה:
  // הוא תופס גם "דואר ישראל" ו"דואר רשום", שאינם קשורים
