...
// did.li נוסף 20.8 אחרי אימות חי (jems.co.il): did.li/tabitjems מפנה ב-301 אל
// tabitorder.com/jemsranna, כלומר קישור ההזמנה של סניף רעננה היה מוסתר מאיתנו לגמרי - גם
// הדגל וגם היעד. זה מקצר ישראלי, ולכן דווקא הוא זה שחוזר באתרי עסקים כאן.
// t.co קשור בכוונה ל-// שלפניו: בלי העיגון כל מארח שנגמר ב-t.co (smartsupport.co למשל)
// נספר כמקצר, והדגל היה מכבה חוק של 25 נקודות בגלל התאמת שווא
const SHORTENER_RE = /bit\.ly\/|tinyurl\.com\/|cutt\.ly\/|\/\/t\.co\/|goo\.gl\/|is\.gd\/|rb\.gy\/|did\.li\//;
