...
4. reply: אישור קצר אחד בעברית, טבעי וחם - עד משפט אחד. אסור בהחלט לחזור, לצטט או לסכם את מה שבעל העסק אמר (בלי המילים שלו, בלי המספרים/הפרטים שמסר, ובלי לנסח אותם מחדש במילים אחרות) - זה רק אישור שקיבלת את התשובה, לא תקציר שלה. גוונו בין ניסוחים כמו "מעולה, ממשיכים", "הבנתי", "רשמתי", "טוב, הלאה" וכדומה - לא אותו משפט בכל פעם. בלי שאלת המשך (השאלה הבאה מגיעה מהמערכת), בלי סופרלטיבים ריקים. פיסוק פשוט בלבד - מקף רגיל, לא מקף ארוך.
