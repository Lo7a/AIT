    ...
    <main className="mx-auto max-w-2xl px-4 py-16">
      ...
      <section className="mt-10 animate-fade-up" style={{ animationDelay: "80ms" }}>
        <div className="flex flex-wrap items-start gap-6">
          <div className="shrink-0">
            {overall == null ? (
              <p className="font-[family-name:var(--font-serif)] text-4xl font-bold text-[#6F6E6A]">
                אין די מידע
              </p>
            ) : (
              <p
                className={`font-[family-name:var(--font-serif)] text-7xl font-bold leading-none tabular-nums sm:text-8xl ${TONE_TEXT_CLASSES[tone]}`}
              >
                {overall}
          ...
          <div className="min-w-[240px] flex-1">
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="font-[family-name:var(--font-serif)] text-3xl font-bold leading-tight sm:text-4xl">
                {headline}
              </h1>
              {usedFallback && (
      ...
      {topGaps.length > 0 && (
        <section className="mt-12 animate-fade-up" style={{ animationDelay: "640ms" }}>
          <h2 className="font-[family-name:var(--font-serif)] text-xl font-bold tracking-tight">
            הפערים המובילים
          </h2>
      ...
      {model && nextStep && (
        ...
        >
          <div className="flex items-baseline justify-between gap-4">
            ...
            <span className="font-[family-name:var(--font-serif)] text-3xl font-bold tabular-nums">
