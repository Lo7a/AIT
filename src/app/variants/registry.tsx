...
export interface VariantScreens {
  ...
  Interview: ComponentType<{
    ...
    businessName?: string;
    // שורת העובדות בסרגל (בקשת אלעד 26.8): אותה שורה כמו בדוח ובתוכנית העבודה. נגזרת
    // בעמוד ומגיעה מוכנה; אופציונלית מאותה סיבה כמו businessName
    facts?: import("../ui/business-facts").BusinessFactsProps;
    isAdmin?: boolean;
    // האימייל של המשתמש המחובר - לתפריט המשתמש בסרגל ולתחתית הסיידבר
    userEmail?: string | null;
  }>;
