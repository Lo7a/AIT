  ...
  return (
    <div className="app">
      <aside className="side-nav">
        ...
        {/* עוגן העסק: זהות בלבד. הציון הוסר במשוב אלעד 24.8 - הוא כבר יושב בטבעת
            הגדולה בראש הדוח, ואותו מספר פעמיים על אותו מסך הוא רעש. מה שכן חסר כאן
            הוא הפנקס (מה חסר לאבחון), והוא ייכנס לכאן כשיהיה - זה המקום שרואים בכל מסך */}
